# 1 "z:\\transfer vms\\vugen\\scripts\\http-html\\aosnimbus-web-s04 purchase\\\\combined_AOSNimbus-Web-S04 Purchase.c"
...
# 1 "z:\\transfer vms\\vugen\\scripts\\http-html\\aosnimbus-web-s04 purchase\\\\combined_AOSNimbus-Web-S04 Purchase.c" 2
...
# 2 "z:\\transfer vms\\vugen\\scripts\\http-html\\aosnimbus-web-s04 purchase\\\\combined_AOSNimbus-Web-S04 Purchase.c" 2
...
# 3 "z:\\transfer vms\\vugen\\scripts\\http-html\\aosnimbus-web-s04 purchase\\\\combined_AOSNimbus-Web-S04 Purchase.c" 2
...
# 4 "z:\\transfer vms\\vugen\\scripts\\http-html\\aosnimbus-web-s04 purchase\\\\combined_AOSNimbus-Web-S04 Purchase.c" 2
...
lr_end_transaction("AOS-Web-S04-01 Access AOS URL",2);
...
lr_end_transaction("AOS-Web-S04-02 Sign In",2);
...
lr_end_transaction("AOS-Web-S04-03 Speakers",2);
...
lr_end_transaction("AOS-Web-S04-04 Random Product",2);
...
lr_end_transaction("AOS-Web-S04-05 Add To Cart",2);
...
lr_end_transaction("AOS-Web-S04-06 Checkout",2);
...
lr_end_transaction("AOS-Web-S04-07 Order Payment Next and Pay Now",2);
...
lr_end_transaction("AOS-Web-S04-08 Sign Out",2);

	lr_think_time(10);

	return 0;
}
# 5 "z:\\transfer vms\\vugen\\scripts\\http-html\\aosnimbus-web-s04 purchase\\\\combined_AOSNimbus-Web-S04 Purchase.c" 2
...
# 6 "z:\\transfer vms\\vugen\\scripts\\http-html\\aosnimbus-web-s04 purchase\\\\combined_AOSNimbus-Web-S04 Purchase.c" 2
